...
#define GICR_TYPER_LPI_AFFINITY_SHIFT		24
#define GICR_TYPER_LPI_AFFINITY_MASK		0x3UL
#define GICR_TYPER_LPI_AFFINITY_GET(_val)	MASK_GET(_val, GICR_TYPER_AFFINITY_VALUE)
...
#define GICR_SGI_ACTIVE         0x0300
#define GICR_SGI_ICACTIVE       0x0380
