...
#define MT_VM_DEVICE_MEM_RO     (MT_S2_R | MT_S2_EXECUTE_NEVER | MT_S2_DEVICE_GRE | MT_S2_ACCESS_ON)
...
/**
 * @brief Clean a partition xlat usage count.
 */
void arch_vm_mem_table_count_clean(struct k_mem_domain *domain,
