...
#ifdef CONFIG_ZVM_MEMORY_RECORDER
struct memory_record_heap memory_recorder;
#endif
...
#ifdef CONFIG_ZVM_MEMORY_RECORDER
static void memory_recorde_init(){
	memory_recorder.top = 0;
	memory_recorder.mem[memory_recorder.top] = (CONFIG_SRAM_SIZE * 1024) * 0.739 - CONFIG_HEAP_MEM_POOL_SIZE ;
	memory_recorder.total_size = memory_recorder.mem[memory_recorder.top];
}
#endif
