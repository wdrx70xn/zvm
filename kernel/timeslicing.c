...
#ifdef CONFIG_TIMESLICE_US
    #define SLICE_TICKS DIV_ROUND_UP(CONFIG_TIMESLICE_SIZE * Z_HZ_ticks, Z_HZ_us)
#else
    #define SLICE_TICKS DIV_ROUND_UP(CONFIG_TIMESLICE_SIZE * Z_HZ_ticks, Z_HZ_ms)
#endif

static int slice_ticks = SLICE_TICKS;
